<?php
    ...
    echo"<h2>การใช้ implode (การสร้างอาร์เรย์จากสติง)</h2>";
    ...
    echo"การเข้ารหัสแบบ sha-256 เป็นการเข้ารหัสแบบทางเดียว (one-way encryption) เนื่องจาก sha-256 เป็นฟังชั่นแฮชที่ออกแบบมาเพื่อความปลอดภัยไม่มีคำสั้งหีือวิธีการที่สามารถแปลงกลับ ข้อความที่ถูกแฮชด้วย sha-256 กลับไปเป็นข้อความต้นฉบับได้โดยง่าย";
